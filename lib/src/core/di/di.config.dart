...
import '../../features/home/data/datasources/weather_datasource.dart' as _i28;
...
import '../../features/home/domain/use_cases/weather_use_case.dart' as _i32;
...
import '../../features/my_app/domain/repositories/system_repository.dart'
    as _i25;
import '../../features/my_app/domain/use_cases/system_use_case.dart' as _i27;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i23.SystemDataSource>(() => _i24.SystemDataSourceImpl());
  gh.factory<_i25.SystemRepository>(
      () => _i26.SystemRepositoryImpl(gh<_i23.SystemDataSource>()));
  gh.factory<_i27.SystemUsecase>(
      () => _i27.SystemUsecaseImpl(gh<_i25.SystemRepository>()));
  gh.factory<_i28.WeatherDataSource>(() => _i29.WeatherDataSourceImpl());
  gh.factory<_i30.WeatherRepository>(
      () => _i31.WeatherRepositoryImpl(gh<_i28.WeatherDataSource>()));
  gh.singleton<_i32.GetWeatherUseCase>(
      _i32.GetWeatherUseCaseImpl(gh<_i30.WeatherRepository>()));
  return getIt;
}
